        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (release != null) {
                ...
                core.info("get deployment");
                 let deployment = yield releaseApi.getDeployments(project:projectName, definitionId:release.releaseDefinition.id, definitionEnvironmentId:release.definitionEnvironmentId, latestAttemptsOnly: true);
