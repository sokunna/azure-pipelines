        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (release != null) {
                ...
                core.info("get deployment");
                 let deployment = yield releaseApi.getDeployments(projectName, release.releaseDefinition.id, release.definitionEnvironmentId, undefined, undefined, undefined, undefined, true);
