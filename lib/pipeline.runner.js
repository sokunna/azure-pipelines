    ...
    RunDesignerPipeline(webApi) {
     ...
     waitForRelease(projectName, releaseApi, release) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (deployment.status == ReleaseInterfaces_1.DeploymentStatus.Succeeded || deployment.status == ReleaseInterfaces_1.DeploymentStatus.InProgress ) {
            ...
            if (deployment.status !== ReleaseInterfaces_1.DeploymentStatus.Succeeded ) {
                let suffix = '';
