    ...
    RunDesignerPipeline(webApi) {
     ...
     waitForRelease(projectName, releaseApi, release) {
        return __awaiter(this, void 0, void 0, function* () {
             ...
             let deployments = yield releaseApi.getDeployments(projectName, release.releaseDefinition.id, release.environments[0].definitionEnvironmentId, release.createdBy.uniqueName, release.createdOn);
