        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (release != null) {
                ...
                core.info("get deployment");
                 let deployment = yield releaseApi.getDeployments(projectName, release.releaseDefinition.id, release.definitionEnvironmentId, release.createdBy.uniqueName, release.createdOn, release.modifiedOn);
